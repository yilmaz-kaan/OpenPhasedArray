...
class ReplicateLayoutGUI ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Replicate layout", pos = wx.DefaultPosition, size = wx.Size( 439,655 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
        ...
        self.chkbox_group_layouts.Bind( wx.EVT_CHECKBOX, self.group_layout_changed )
